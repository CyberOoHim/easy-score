...
export const KeyboardToScoreModal: React.FC<KeyboardToScoreModalProps> = ({
  ...
  const content = (
    <div
      id={isEmbedded ? "keyboard-to-score-studio-container" : "keyboard-to-score-modal-dialog"}
      role={isEmbedded ? "region" : "dialog"}
      aria-modal={isEmbedded ? undefined : "true"}
      aria-labelledby="keyboard-modal-title"
      className={isEmbedded
        ? "relative w-full bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-3xl shadow-xl overflow-hidden flex flex-col transition-all"
        : "relative w-full max-w-4xl bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-3xl shadow-2xl overflow-hidden flex flex-col my-auto max-h-[95vh]"
      }
      ...
      <div className="flex items-center justify-between px-6 py-4 border-b border-zinc-200 dark:border-zinc-800 bg-zinc-50/70 dark:bg-zinc-900/50 backdrop-blur-xs shrink-0">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            title={isEmbedded ? "重設回到設定" : "關閉 (Esc)"}
            aria-label="關閉"
          >
